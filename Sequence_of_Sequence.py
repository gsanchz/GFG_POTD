...
class Solution:
    def numberSequence(self, m, n):
        ...
        last_number_taken = Solution.numberSequence(self,m/2, n-1)
        last_number_not_taken = Solution.numberSequence(self,m-1,n)
        return last_number_taken + last_number_not_taken
